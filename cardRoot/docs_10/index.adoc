...
Let us go over the most important terms and concepts in the Cyberismo solution. For a more detailed introduction for module developers, please see xref:docs_12[Cyberismo concepts].  
