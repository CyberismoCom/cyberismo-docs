...
The configuration editor is the recommended way to manage field types.
...
NOTE: You do not need to edit the JSON files directly. The configuration editor provides a graphical interface for managing all field type properties.
