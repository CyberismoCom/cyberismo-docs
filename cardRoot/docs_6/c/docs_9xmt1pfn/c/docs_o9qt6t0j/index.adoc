Cyberismo content modules and projects may define their own logic programs by including a file with the extension `.lp` in the `.cards/local/calculations` folder. The logic programs in the calculations folder are automatically included as part of the Cyberismo main logic program.
