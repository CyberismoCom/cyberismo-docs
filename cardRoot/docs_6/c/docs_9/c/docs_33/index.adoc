This page introduces the Cyberismo query language. A Cyberismo query uses logic programming facts and rules to "sculpt" its result as a JavaScript Object Notation (JSON) query result object.
