...
==== Adding default hub
If user has removed the default hub, or project was created before hub support was added to cyberismo tool, the default hub can be added to the project with command:
