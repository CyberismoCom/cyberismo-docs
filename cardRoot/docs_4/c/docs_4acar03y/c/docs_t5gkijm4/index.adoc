...
Graph views may define additional view-specific parameters. For example, the workflow graph view uses a `"workflow"` parameter to specify which workflow to visualize.
